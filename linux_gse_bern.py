# -*- coding: utf-8 -*-
"""
Created on Sun Mar 21 21:48:34 2021
...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 21 17:23:10 2021
...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 19 13:46:47 2021
...
try:
    ...
    def pipeline(gse, output = 'zrb_pipeline_bern_result'):
        ...
        #     title=['gse','gsm','text','bern_text','cell line','organism','cell type','method','source name','tissue','treatment','disease','bern_zrb_disease','bern_zrb_disease_id','bern_zrb_drug','bern_zrb_drug_id','bern_zrb_gene','bern_zrb_gene_id'] 
            title=['gse','gsm','text','bern_text','cell line','organism','cell type','method','source name','tissue','treatment','disease','library_strategy','bern_disease_str','bern_disease_id_str','normolize_disease_id_name','normolize_disease_name','bern_drug_str','bern_drug_id_str','normolize_drug_id_name','normolize_drug_name','bern_gene_str','bern_gene_id_str','normolize_gene_id_name','normolize_gene_name','knock_out/knock_down','knock_in','knock','over_expression','cell_line_text_regex','cell_line_bern_text_regex','gsm_rrid_cell_line','gsm_rrid_disease']     
       ...
       # print(file_list)
        ...
        for i_file in file_list:
            ...
            for i_s in range(sample.length):
                ...
                try:
                    s_platform_ref=sample[i_s].getElementsByTagName("Platform-Ref")[0].childNodes[0].data
            ...
            #换行符和多个空格的问题
                ...
                hdq_bern_list=[hdq_disease_str,hdq_disease_id_str,disease_output_id_disease_name_str,disease_output_disease_name_str,hdq_drug_str,hdq_drug_id_str,drug_output_id_drug_name_str,drug_output_drug_name_str,hdq_gene_str,hdq_gene_id_str,gene_output_id_gene_name_str,gene_output_gene_name_str,knock_out_down,knock_in,knock,over,cell_line_text_str,cell_line_bern_text_str,gsm_rrid_cell_line,gsm_rrid_disease]
    ...
    print('bern connection does breakdown!!!')
