...
class Normalize:
    ...
    ##########################################################################                        
                ...
                disease_output_disease_name_list.append(disease_output_disease_name)
    ...
    ##########################################################################                        
                ...
                drug_output_drug_name_list.append(drug_output_drug_name)
    ...
    def gene (self):
        if self.name != 'null' and self.name !='bern_zrb_gene_id' :
            ...
            for i in gene_list:
                ...
                gene_output_gene_name_list.append(gene_output_gene_name)
                gene_output_id_gene_name=''
                gene_output_gene_name=''
